CC  = armv6-rpi-linux-gnueabi-gcc
CPP = armv6-rpi-linux-gnueabi-g++

LFLAGS_LIB  =
LFLAGS_APP  = -L${SEABREEZE}/lib -L/home/ken/libusb-0.1.12
CFLAGS_BASE = -I${SEABREEZE}/include \
              -I/home/ken/x-tools/armv6-rpi-linux-gnueabi/armv6-rpi-linux-gnueabi/include/c++/4.7.3 \
              -I/home/ken/libusb-0.1.12 \
              -c \
              -Wall \
              -Wunused \
...
# Linux configuration
    ...
    SUFFIX      = so
    LIBBASENAME = libseabreeze
    LFLAGS_APP += -L/home/ken/x-tools/armv6--rpi-linux-gnueabi/armv6-rpi-linux-gnueabi/lib \
                  -lusb \
                  -lstdc++ \
                  -lm
    LFLAGS_LIB += -L/home/ken/x-tools/armv6--rpi-linux-gnueabi/armv6-rpi-linux-gnueabi/lib \
                  -shared
endif
