...
public partial class SeaBreezeWrapper
{
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern void   seabreeze_set_integration_time               (int index, ref int errorCode, long integration_time_micros); 
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern long   seabreeze_get_minimum_integration_time_micros(int index, ref int errorCode); 
    ...
    [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)] public static extern int    seabreeze_set_integration_clock_to_GPIO      (int index, ref int errorCode, int enable); 
