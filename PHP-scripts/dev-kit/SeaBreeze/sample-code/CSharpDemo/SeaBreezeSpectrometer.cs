...
public class SeaBreezeSpectrometer : Spectrometer
{
    ...
    private int specIndex = 0;              // for now, hardcode to use first enumerated spectrometer
    ...
    public bool setIntegrationTimeMilliseconds(int ms)
    {
        ...
        {
            int error = 0;
            SeaBreezeWrapper.seabreeze_set_integration_time(specIndex, ref error, (long)ms * 1000);
            result = checkSeaBreezeError("set_integration_time", error);
        }
        catch (Exception e)
        {
